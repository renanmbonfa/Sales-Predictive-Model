...
Após tratar o dataset e executar os modelos, observei que obtive resultados relativamente próximos. Tentei inúmeras vezes rodar o modelo de redes neurais, mas não tive exito.

No caso da regressão linear, tentei fazer regularização lasso e ridge, porém não obtive bons resultados, por isso optei por deixar no trabalho a regressão linear  
com cross-validation sem regularização.

Dentros os modelos testados, o modelo que apresentou melhores resultados foi
o.... com Rsquared de.. e MSE de ...
